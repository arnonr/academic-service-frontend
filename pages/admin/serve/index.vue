    ...
    <div class="container">
      <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
        <h4>
          ...
          <span class="ml-10">รายการการให้บริการ</span>
        </h4>
      </div>
      <div class="mb-30">
        <button
            ...
            <table class="table table-bordered table-striped table-admin">
              <thead>
                <tr>
                  ...
                  <th class="text-center">ประเภทการบริการ</th>
              ...
              <tbody v-if="items.length != 0">
                <tr v-for="(it, idx) in items" :key="idx">
                  <td cla ss="text-center">{{ it.title_th }}</td>
                  <td class="text-center">
                    {{ it.title_en }}
                  </td>
                  <td class="text-center"> {{ it.department.name_th }}</td>
                  <td class="text-center"> {{ it.service_category.name_th }}</td>
                  <td class="text-center">
                    <span
...
const onDelete = async (id) => {
  await $fetch(`${runtimeConfig.public.apiBase}/serve/${id}`, {
    method: "delete",
  })
    .then((res) => {
      if (res.msg == "success") {
