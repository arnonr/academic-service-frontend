            ...
            <div class="header__top-4 header__padding-4">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-6 col-md-5 col-5">
                            <div class="logo text-start">
                                ...
                                <h3
                                    class="d-none d-xl-block d-lg-block text-color-primary"
                                >
                                    งานบริการวิชาการ
                                </h3>
                                <h5
                                    class="d-none d-xl-block d-lg-block text-dark"
                                >
                    ...
                    <slot name="loading"> -->
                                    ...
                                    <!-- memu mobile -->
                                    <div
                                        class="header__hamburger d-lg-none float-end"
                                    >
                                        <button
                ...
                <div class="container">
                    <div class="mega-menu-wrapper p-relative">
                        <div class="row align-items-center">
                            ...
                            <div
                                class="col-xxl-8 col-xl-8 col-lg-8 d-none d-lg-block"
                            >
                                <div
