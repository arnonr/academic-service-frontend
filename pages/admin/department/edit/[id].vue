                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mt-10">
                                <label
                                    for="staticEmail"
                                    class="col-sm-3 col-form-label"
                                    ><span class="text-danger">*</span>ลำดับ :
                                </label>
                                <div class="col-sm-9">
                                    <input
                                        type="text"
                            ...
                            <div class="form-group row mt-10">
                                ...
                                <div class="col-sm-9">
                                    <client-only>
                                        <froala
                                            tag="textarea"
                                            :config="config.contact_en"
                                            v-model="item.contact_en"
                                        ></froala>

                                        <div id="contact-en"></div>
                                    </client-only>
                                </div>
                            </div>
                        </div>
...
const onSubmit = async () => {
    ...
    let type_object = {
        ...
        method: "put",
        url: runtimeConfig.public.apiBase + "/department/" + item.value.id,
    };
